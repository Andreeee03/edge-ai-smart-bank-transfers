...
HF_MODEL_PATH = ROOT / "models/lfm2_700m_claude_merged"

GGUF_MODELS = {
    "F16": ROOT / "models/gguf/LFM2-700M_Claude-DS_F16.gguf",
    "Q4_K_M": ROOT / "models/gguf/LFM2-700M_Claude-DS_Q4_K_M.gguf",
    "Q5_K_M": ROOT / "models/gguf/LFM2-700M_Claude-DS_Q5_K_M.gguf",
}

LLAMA_SERVER = Path("/home/ubuntu/llama.cpp/build/bin/llama-server")

TEST_FILE = ROOT / "data_Claude/processed/test_sft.jsonl"

OUTPUT_DIR = ROOT / "evaluation/final_quantization_validation_claude"
